---
title: FINOP and Audit Readiness Checklist
slug: finop-audit-readiness-checklist
datePublished: '2026-08-27'
dateModified: '2026-08-27'
sections:
  - type: GenericSection
    title:
      text: FINOP and Audit Readiness Checklist for Broker-Dealers
      color: text-dark
      type: TitleBlock
    text: >-
      A practical review of books and records, net capital, FOCUS reporting,
      annual-audit preparation, and the operating controls behind each filing.
    ...
    actions:
      - label: Get the PDF Checklist
        ...
        style: primary
        type: Button
      - label: View the Online Checklist
        altText: Jump to the online FINOP and audit readiness checklist
        url: '#checklist'
        showIcon: true
        icon: arrowDown
        iconPosition: right
        ...
        type: Link
    badge:
      label: Downloadable FINOP Resource
      color: text-primary
      type: Badge
    bottomText: Six-page printable checklist · Updated August 2026
    colors: bg-light-fg-dark
    styles:
      self:
        flexDirection: col
        padding: [pt-20, pb-16, pl-6, pr-6]
  - title: Divider
    colors: bg-light-fg-dark
    styles:
      self:
  ...
  - type: GenericSection
    ...
    styles:
      self:
        flexDirection: col
        padding: [pt-16, pb-16, pl-6, pr-6]
  - type: GenericSection
    elementId: checklist
    title:
      text: 1. Financial Books and Records
      color: text-dark
      type: TitleBlock
    text: |
  ...
  - type: GenericSection
    title:
      text: 2. Net Capital and Liquidity
      color: text-dark
      type: TitleBlock
    text: |
  ...
  - type: GenericSection
    title:
      text: 3. FOCUS and Regulatory Reporting
      color: text-dark
      type: TitleBlock
    text: |
      ...
      FINRA states that member firms submit FOCUS reports through eFOCUS pursuant to SEC Rule 17a-5. [FINRA's eFOCUS resource provides current system guidance, forms, and templates](https://www.finra.org/filing-reporting/efocus).
    badge:
      label: Checklist
      color: text-primary
      type: Badge
  ...
  - type: GenericSection
    title:
      text: 4. Annual Audit Preparation
      color: text-dark
      type: TitleBlock
    text: |
      ...
      [The SEC's broker-dealer reports guide describes annual financial reports and applicable compliance or exemption reports](https://www.sec.gov/resources-small-businesses/small-business-compliance-guides/broker-dealer-reports).
    badge:
      label: Checklist
      color: text-primary
      type: Badge
  ...
  - type: GenericSection
    title:
      text: 5. Controls, Documentation, and Examination Readiness
      color: text-dark
      type: TitleBlock
    text: |
      ...
      FINRA Rule 1220 assigns the FINOP responsibility for financial reports, the records supporting them, financial-responsibility rules, and back-office financial operations. [Review the current FINOP duties in FINRA Rule 1220](https://www.finra.org/rules-guidance/rulebooks/finra-rules/1220).
    actions:
      - label: Read What a FINOP Does
        altText: Read the guide to FINOP responsibilities
  ...
  - type: FaqSection
    badge:
      ...
      type: Badge
    title:
      text: FINOP Readiness Checklist Questions
      color: text-dark
      type: TitleBlock
    description: Common questions about using the checklist with an introducing broker-dealer.
    items:
      - question: Is this an official FINRA or SEC checklist?
        answer: >-
          No. This is a general operating resource prepared by Eirik Nordgaard.
          It draws on public FINRA and SEC guidance but does not replace current
          rules, filing instructions, legal advice, audit guidance, or a
          firm-specific compliance review.
      - question: Does the checklist replace the auditor's request list?
        answer: >-
          No. The independent auditor will provide a request list based on the
          firm's activities, fiscal year, audit scope, and applicable reporting
          requirements. This checklist helps the firm organize recurring work
          before that request becomes urgent.
      - question: Who should complete the checklist?
        answer: >-
          The process commonly involves management, accounting personnel, the
          FINOP, compliance, and the independent auditor. Each item should have
          a clearly identified preparer, reviewer, owner, and due date.
    colors: bg-light-fg-dark
    styles:
      self:
        padding: [pt-16, pb-16, pl-6, pr-6]
  - type: GenericSection
    title:
      text: Need Help Establishing the Operating Cadence?
      color: text-dark
      type: TitleBlock
    text: >-
      I provide outsourced and fractional Series 28 FINOP support for
      introducing broker-dealers, including books and records oversight, net
      capital monitoring, FOCUS reporting, annual-audit coordination, and
      regulatory response support.
    actions:
      - label: Schedule a Confidential Call
        altText: Schedule a confidential call about FINOP support
    ...
    styles:
      self:
        ...
        padding: [pt-16, pb-16, pl-6, pr-6]
seo:
  metaTitle: FINOP Audit Readiness Checklist for Broker-Dealers
